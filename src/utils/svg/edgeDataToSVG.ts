...
export function edgeDataToSVG(
  ...
  return generateSVG(simplifiedPaths, width, height, strokeWidth, strokeColor, time, opacity, fill, connectEdges, useBezier, groupId, useWiggle, useDashArray, dashSize);
}
